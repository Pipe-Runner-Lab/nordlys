      ...
      <Select
        ...
        {buildingDataMap.map(({ type, id, x, z }) => {
          switch (type) {
            ...
            case 'office':
              return <Office uuid={id} key={id} x={x} z={z} />;
            case 'skyscraper':
              return <Skyscraper uuid={id} key={id} x={x} z={z} />;
            case 'hotel':
              return <Hotel uuid={id} key={id} x={x} z={z} />;
            case 'government':
              return <Government uuid={id} key={id} x={x} z={z} />;
            case 'house':
              return <House uuid={id} key={id} x={x} z={z} />;
            case 'shop':
              return <Shop uuid={id} key={id} x={x} z={z} />;
            case 'hospital':
              return <Hospital uuid={id} key={id} x={x} z={z} />;
            default:
              return null;
          }
        })}
